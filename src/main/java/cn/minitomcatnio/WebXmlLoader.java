...
public class WebXmlLoader {
    ...
    public static void load(Context context) {
        ...
        try {
            ...
            for (int i = 0; i < servletNodes.getLength(); i++) {
                ...
                servlets.put(name, newInstance(className, Servlet.class));
            }
            ...
            for (int i = 0; i < filterNodes.getLength(); i++) {
                ...
                filters.put(name, newInstance(className, Filter.class));
            }
    ...
    private static <T> T newInstance(String className, Class<T> type) throws Exception {
